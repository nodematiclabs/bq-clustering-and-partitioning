...
# Add schema, partitioning, and clustering settings
table.schema = [
...
table.time_partitioning = bigquery.TimePartitioning(type_=TimePartitioningType.YEAR, field="datetime")
table.clustering_fields = ["system"]

# Create the table with the partitioning and clustering settings
